...
def main():
    ...
    cluster_parser.add_argument("--algorithm", type=ClusteringAlgorithm, choices=['kmeans','kmedoids'], default='k-means', help="Clustering algorithm (default: kmeans)")
    ...
    compress_parser.add_argument("--algorithm", type=Compression_Algorithm, choices=['kmeans','kmedoids'], default='k-means', help="Compression algorithm (default: kmeans)")
