...
iceberg_image_path = "images/iceberg.png"
...
sample1_image_path = "images/sample1.bmp"


def run_kmeans_and_display_image():
    image_path = sample1_image_path
...
def run_compress_image():
    ...
    algorithm = lambda image: kmeans(image, num_clusters=2, max_iterations=10, norm=2)
